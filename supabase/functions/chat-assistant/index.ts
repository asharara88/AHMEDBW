...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (userData?.is_demo) {
      ...
      const responseContent = DEMO_RESPONSES[userMessage] || DEMO_RESPONSES.default;
        ...
        ? [
            {
              ...
              content: `User Context: ${JSON.stringify({
                name: userData.first_name ? `${userData.first_name} ${userData.last_name || ""}` : "Anonymous",
