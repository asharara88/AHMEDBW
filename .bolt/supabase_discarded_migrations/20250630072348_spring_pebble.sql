/*
  # Fix Audio Cache System

  1. New Tables
    - Ensures `audio_cache` table exists with proper structure
    - Adds indexes for performance optimization
  
  2. Security
    - Enables RLS on the table
    - Creates policies for user access if they don't already exist
  
  3. Automation
    - Sets up trigger for automatic cleanup of expired entries
*/
