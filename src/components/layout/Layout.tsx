          ...
          <div className="grid gap-6 md:grid-cols-12">
            ...
            <div className="md:col-span-7 lg:col-span-8">
              ...
              <TabsContent value="planner" className="mt-0">
                <div className="rounded-xl border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-4">
                          <div key={meal} className="rounded-lg border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-3">
                            ...
                            <div className="text-center py-2 text-sm text-text-light">
                              No meals planned
                            </div>
                          </div>
                        ))}
                    ...
                    <div className="rounded-lg border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface-1))] p-4">
                      <h4 className="mb-3 text-base font-medium">Workout Plan</h4>
                      
                      <div className="space-y-3">
                        <div className="rounded-lg border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-3">
                          <div className="mb-2 flex items-center justify-between">
                            <h5 className="font-medium">Workout</h5>
                            <div className="flex items-center gap-2">
                              <button
                                className="rounded-lg bg-primary px-2 py-1 text-xs text-white hover:bg-primary-dark"
