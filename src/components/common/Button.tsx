...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-xl font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-40',
  {
    variants: {
      variant: {
        ...
        success: 'bg-success text-white shadow-lg shadow-success/25 hover:bg-success/90 hover:shadow-xl hover:shadow-success/30 active:scale-[0.98]',
        error: 'bg-error text-white shadow-lg shadow-error/25 hover:bg-error/90 hover:shadow-xl hover:shadow-error/30 active:scale-[0.98]',
      },
      size: {
        sm: 'h-9 px-4 text-sm',
        md: 'h-11 px-6',
